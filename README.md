...
buildscript {
    dependencies {
        classpath 'com.nextfaze.devfun:devfun-gradle-plugin:1.0.2'
    }
}
```
...
```gradle
    ...
    kaptDebug 'com.nextfaze.devfun:devfun-compiler:1.0.2'
    compile 'com.nextfaze.devfun:devfun-annotations:1.0.2'
    debugCompile 'com.nextfaze.devfun:devfun-menu:1.0.2'
    
    // Dagger 2.x component inspector - only if using Dagger 2.x!
    debugCompile 'com.nextfaze.devfun:devfun-inject-dagger2:1.0.2'
    
    // Chrome Dev Tools JavaScript console integration
    debugCompile 'com.nextfaze.devfun:devfun-stetho:1.0.2'
        
    // HTTP server and simple index page
    debugCompile 'com.nextfaze.devfun:devfun-httpd:1.0.2'
    debugCompile 'com.nextfaze.devfun:devfun-httpd-frontend:1.0.2'
    
    // Glide util functions
    debugCompile 'com.nextfaze.devfun:devfun-util-glide:1.0.2'
    
    // Leak Canary util functions
    debugCompile 'com.nextfaze.devfun:devfun-util-leakcanary:1.0.2'
    ...
    // debugCompile 'com.nextfaze.devfun:devfun-invoke-view-colorpicker:1.0.2'
    
    // DevFun core - transitive included from menu et al.
    // debugCompile 'com.nextfaze.devfun:devfun:1.0.2' 
```
