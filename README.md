...
buildscript {
    dependencies {
        classpath 'com.nextfaze.devfun:devfun-gradle-plugin:1.1.0'
    }
}
```
...
```gradle
    ...
    kaptDebug 'com.nextfaze.devfun:devfun-compiler:1.1.0'
    compile 'com.nextfaze.devfun:devfun-annotations:1.1.0'
    debugCompile 'com.nextfaze.devfun:devfun-menu:1.1.0'
    
    // Dagger 2.x component inspector - only if using Dagger 2.x!
    debugCompile 'com.nextfaze.devfun:devfun-inject-dagger2:1.1.0'
    
    // Chrome Dev Tools JavaScript console integration
    debugCompile 'com.nextfaze.devfun:devfun-stetho:1.1.0'
        
    // HTTP server and simple index page
    debugCompile 'com.nextfaze.devfun:devfun-httpd:1.1.0'
    debugCompile 'com.nextfaze.devfun:devfun-httpd-frontend:1.1.0'
    
    // Glide util functions
    debugCompile 'com.nextfaze.devfun:devfun-util-glide:1.1.0'
    
    // Leak Canary util functions
    debugCompile 'com.nextfaze.devfun:devfun-util-leakcanary:1.1.0'
    ...
    // debugCompile 'com.nextfaze.devfun:devfun-invoke-view-colorpicker:1.1.0'
    
    // DevFun core - transitive included from menu et al.
    // debugCompile 'com.nextfaze.devfun:devfun:1.1.0' 
```
