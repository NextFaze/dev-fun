...
dependencies {
    ...
    debugImplementation("com.nextfaze.devfun:devfun-menu:2.0.0-RC2")
    ...
    debugImplementation("com.nextfaze.devfun:devfun-httpd:2.0.0-RC2")
    debugImplementation("com.nextfaze.devfun:devfun-httpd-frontend:2.0.0-RC2")
    ...
    // debugImplementation("com.nextfaze.devfun:devfun-invoke-view-colorpicker:2.0.0-RC2")
