...
class cpat_SomeClass {
    ...
    fun testAllDefaults(ref: MethodReference) {
        ...
        run nestedAllDefault@{
            ...
            val anotherSimpleTypesWithDefaultsNested = nestedAllDefault["anotherSimpleTypesWithDefaults"] as Map<String, *>
            ...
            val arrayTypesWithDefaults = nestedAllDefault["arrayTypesWithDefaults"] as Map<String, *>
            ...
            val classArrayPropertiesWithDefaultsNested = nestedAllDefault["classArrayPropertiesWithDefaults"] as Map<String, *>
            expectArrayOf(Any::class, Int::class, BooleanArray::class, Unit::class, Nothing::class) {
            ...
            val complexTypesWithDefaultsNested = nestedAllDefault["complexTypesWithDefaults"] as Map<String, *>
            ...
            val arrayOfAnnotations = nestedAllDefault["arrayOfAnnotations"] as Array<Map<String, *>>
            arrayOfAnnotations.forEachIndexed { index, map ->
                expect(true) { map["defaultBoolean"] }
                expect(0xA) { map["defaultByte"] }
                expect(12) { map["defaultShort"] }
        ...
        run nestedCustom@{
            ...
            val anotherSimpleTypesWithDefaultsNestedCustom = nestedCustom["anotherSimpleTypesWithDefaults"] as Map<String, *>
            ...
            val arrayTypesWithDefaults = nestedCustom["arrayTypesWithDefaults"] as Map<String, *>
            expectArrayOf(false, false) { arrayTypesWithDefaults["defaultBooleans"] }
            ...
            val classArrayPropertiesWithDefaultsNestedCustom = nestedCustom["classArrayPropertiesWithDefaults"] as Map<String, *>
            expectArrayOf(Any::class, Int::class, BooleanArray::class, Unit::class, Nothing::class) {
            ...
            val complexTypesWithDefaultsNestedCustom = nestedCustom["complexTypesWithDefaults"] as Map<String, *>
            ...
            val arrayOfAnnotations = nestedCustom["arrayOfAnnotations"] as Array<Map<String, *>>
            arrayOfAnnotations.forEachIndexed { index, map ->
                expect(true) { map["defaultBoolean"] }
                expect(0xA) { map["defaultByte"] }
                expect(12) { map["defaultShort"] }
