...
```gradle
debugCompile 'com.nextfaze.devfun:devfun:0.1.3'
```
...
```gradle
debugCompile 'com.nextfaze.devfun:menu:0.1.3'
```
...
```gradle
debugCompile 'com.nextfaze.devfun:httpd:0.1.3'
```
...
```gradle
debugCompile 'com.nextfaze.devfun:httpd-frontend:0.1.3'
```
