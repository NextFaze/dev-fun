...
```gradle
compile 'com.nextfaze.devfun:devfun-annotations:0.1.8'
```
...
```gradle
kaptDebug 'com.nextfaze.devfun:devfun-compiler:0.1.8'
```
...
```gradle
debugCompile 'com.nextfaze.devfun:devfun:0.1.8'
```
...
```gradle
debugCompile 'com.nextfaze.devfun:menu:0.1.8'
```
...
```gradle
debugCompile 'com.nextfaze.devfun:devfun-inject-dagger2:0.1.8'
```
...
```gradle
debugCompile 'com.nextfaze.devfun:devfun-util-glide:0.1.8'
```
...
```gradle
debugCompile 'com.nextfaze.devfun:devfun-util-leakcanary:0.1.8'
```
...
```gradle
debugCompile 'com.nextfaze.devfun:httpd:0.1.8'
```
...
```gradle
debugCompile 'com.nextfaze.devfun:httpd-frontend:0.1.8'
```
...
```gradle
debugCompile 'com.nextfaze.devfun:devfun-stetho:0.1.8'
```
