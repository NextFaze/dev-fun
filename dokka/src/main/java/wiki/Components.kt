...
```gradle
debugCompile 'com.nextfaze.devfun:menu:1.2.0'
```
...
```gradle
debugCompile 'com.nextfaze.devfun-invoke-view-colorpicker:1.2.0'
```
...
```gradle
debugCompile 'com.nextfaze.devfun:httpd:1.2.0'
```
...
```gradle
debugCompile 'com.nextfaze.devfun:httpd-frontend:1.2.0'
```
