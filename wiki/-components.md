...
``` gradle
debugCompile 'com.nextfaze.devfun:devfun:0.1.2'
```

Modules are loaded by [DevFun](../com.nextfaze.devfun.core/-dev-fun/index.md) using Java's [ServiceLoader](http://docs.oracle.com/javase/6/docs/api/java/util/ServiceLoader.html).

[DevFun](../com.nextfaze.devfun.core/-dev-fun/index.md) loads, transforms, and sorts the generated function definitions, again via the [ServiceLoader](http://docs.oracle.com/javase/6/docs/api/java/util/ServiceLoader.html) mechanism.
...
``` gradle
debugCompile 'com.nextfaze.devfun:menu:0.1.2'
```
...
``` gradle
debugCompile 'com.nextfaze.devfun:httpd:0.1.2'
```
...
``` gradle
debugCompile 'com.nextfaze.devfun:httpd-frontend:0.1.2'
```
