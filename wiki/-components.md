...
`object Components` [(source)](https://github.com/NextFaze/dev-fun/tree/master/dokka/src/main/java/wiki/Components.kt#L369)
...
*Be aware! For properties you must annotate the **getter***
