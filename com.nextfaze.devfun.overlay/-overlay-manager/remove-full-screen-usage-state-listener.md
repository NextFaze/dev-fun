[gh-pages](../../index.md) / [com.nextfaze.devfun.overlay](../index.md) / [OverlayManager](index.md) / [removeFullScreenUsageStateListener](./remove-full-screen-usage-state-listener.md)
