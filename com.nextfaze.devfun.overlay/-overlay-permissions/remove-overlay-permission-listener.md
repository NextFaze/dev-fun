[gh-pages](../../index.md) / [com.nextfaze.devfun.overlay](../index.md) / [OverlayPermissions](index.md) / [removeOverlayPermissionListener](./remove-overlay-permission-listener.md)
